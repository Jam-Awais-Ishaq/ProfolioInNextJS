...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "E-commerce Website with Ai Feshion Designer",
      ...
      github: "https://github.com/Awais-Ishaq-Ai/WearHub",
    },
    {
      id: 2,
      ...
      github: "https://github.com/Awais-Ishaq-Ai/AdminPenal-AJ-styles",
    },
    {
      id: 3,
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    ...
                    className="px-4 py-2 border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md transition-colors duration-300 flex items-center"
                  >
